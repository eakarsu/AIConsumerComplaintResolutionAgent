...
/**
 * Gap/CFS Feature Page: No categorization or assignment workflow.
 * Slug: no-categorization-or-assignment-workflow
 * Backend: /api/gap-no-categorization-or-assignment-workflow
 */
export default function NoCategorizationOrAssignmentWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-categorization-or-assignment-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No categorization or assignment workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No categorization or assignment workflow.</p>
