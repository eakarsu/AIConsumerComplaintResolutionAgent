...
/**
 * Gap/CFS Feature Page: No resolution-prediction or churn-risk scoring.
 * Slug: no-resolution-prediction-or-churn-risk-scoring
 * Backend: /api/gap-no-resolution-prediction-or-churn-risk-scoring
 */
export default function NoResolutionPredictionOrChurnRiskScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-resolution-prediction-or-churn-risk-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No resolution-prediction or churn-risk scoring.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No resolution-prediction or churn-risk scoring.</p>
