...
/**
 * Gap/CFS Feature Page: No sentiment-driven escalation.
 * Slug: no-sentiment-driven-escalation
 * Backend: /api/gap-no-sentiment-driven-escalation
 */
export default function NoSentimentDrivenEscalationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sentiment-driven-escalation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No sentiment-driven escalation.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No sentiment-driven escalation.</p>
