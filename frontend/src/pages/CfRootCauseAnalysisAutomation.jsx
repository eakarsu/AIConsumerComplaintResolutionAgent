...
/**
 * Gap/CFS Feature Page: Root cause analysis automation
 * Slug: root-cause-analysis-automation
 * Backend: /api/cf-root-cause-analysis-automation
 */
export default function RootCauseAnalysisAutomationPage() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Root cause analysis automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Cluster complaints by cause; identify systemic issues.</p>
