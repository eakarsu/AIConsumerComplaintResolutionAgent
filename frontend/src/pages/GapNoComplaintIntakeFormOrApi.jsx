...
/**
 * Gap/CFS Feature Page: No complaint intake form or API.
 * Slug: no-complaint-intake-form-or-api
 * Backend: /api/gap-no-complaint-intake-form-or-api
 */
export default function NoComplaintIntakeFormOrApiPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-complaint-intake-form-or-api', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No complaint intake form or API.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No complaint intake form or API.</p>
