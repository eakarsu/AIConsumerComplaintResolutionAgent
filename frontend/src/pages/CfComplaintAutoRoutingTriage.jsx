...
/**
 * Gap/CFS Feature Page: Complaint auto-routing & triage
 * Slug: complaint-auto-routing-triage
 * Backend: /api/cf-complaint-auto-routing-triage
 */
export default function ComplaintAutoRoutingTriagePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-complaint-auto-routing-triage', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Complaint auto-routing & triage</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>NLP sentiment/intent detection routes to correct department.</p>
