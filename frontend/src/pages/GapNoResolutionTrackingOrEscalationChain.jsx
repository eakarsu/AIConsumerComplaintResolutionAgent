...
/**
 * Gap/CFS Feature Page: No resolution tracking or escalation chain.
 * Slug: no-resolution-tracking-or-escalation-chain
 * Backend: /api/gap-no-resolution-tracking-or-escalation-chain
 */
export default function NoResolutionTrackingOrEscalationChainPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-resolution-tracking-or-escalation-chain', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No resolution tracking or escalation chain.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No resolution tracking or escalation chain.</p>
