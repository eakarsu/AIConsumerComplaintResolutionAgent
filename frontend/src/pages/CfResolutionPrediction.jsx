...
/**
 * Gap/CFS Feature Page: Resolution prediction
 * Slug: resolution-prediction
 * Backend: /api/cf-resolution-prediction
 */
export default function ResolutionPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-resolution-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Resolution prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model predicts likelihood of customer churn; recommend intervention strategy.</p>
