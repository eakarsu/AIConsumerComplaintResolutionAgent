...
/**
 * Gap/CFS Feature Page: No customer communication channel.
 * Slug: no-customer-communication-channel
 * Backend: /api/gap-no-customer-communication-channel
 */
export default function NoCustomerCommunicationChannelPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-customer-communication-channel', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No customer communication channel.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No customer communication channel.</p>
