...
/**
 * Gap/CFS Feature Page: No analytics or reporting.
 * Slug: no-analytics-or-reporting
 * Backend: /api/gap-no-analytics-or-reporting
 */
export default function NoAnalyticsOrReportingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-analytics-or-reporting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No analytics or reporting.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No analytics or reporting.</p>
