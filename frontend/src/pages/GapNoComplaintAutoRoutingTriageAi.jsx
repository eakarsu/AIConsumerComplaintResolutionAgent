...
/**
 * Gap/CFS Feature Page: No complaint auto-routing/triage AI.
 * Slug: no-complaint-auto-routing-triage-ai
 * Backend: /api/gap-no-complaint-auto-routing-triage-ai
 */
export default function NoComplaintAutoRoutingTriageAiPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-complaint-auto-routing-triage-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No complaint auto-routing/triage AI.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No complaint auto-routing/triage AI.</p>
