...
/**
 * Gap/CFS Feature Page: No root-cause clustering AI.
 * Slug: no-root-cause-clustering-ai
 * Backend: /api/gap-no-root-cause-clustering-ai
 */
export default function NoRootCauseClusteringAiPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-root-cause-clustering-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No root-cause clustering AI.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No root-cause clustering AI.</p>
