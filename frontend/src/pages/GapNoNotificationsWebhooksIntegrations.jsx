...
/**
 * Gap/CFS Feature Page: No notifications, webhooks, integrations.
 * Slug: no-notifications-webhooks-integrations
 * Backend: /api/gap-no-notifications-webhooks-integrations
 */
export default function NoNotificationsWebhooksIntegrationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-notifications-webhooks-integrations', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No notifications, webhooks, integrations.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No notifications, webhooks, integrations.</p>
